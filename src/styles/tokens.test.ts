...
// Hex literals updated for the pre-LUMEN cool/slate palette restored
// site-wide for the trading dashboards. The helpers' behavior is
// unchanged; only the hex values they consume/produce shift.
...
describe("token shape", () => {
  it("exposes the core palette", () => {
    ...
    expect(colors.accentBlue).toBe("#3b82f6");
