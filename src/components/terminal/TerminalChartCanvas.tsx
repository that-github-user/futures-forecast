...
function buildEChartsOption(
  ...
  // — i.e. when the RTH session is followed by an ETH bar in the
  // buffer. For the trailing-open RTH run (run still in progress
  // at the last bar of the buffer) we keep the original index so
  // the band doesn't overshoot into nonexistent territory.
  const orRightX =
