...
const REGIME_COLORS: Record<string, string> = {
  ...
  // ink80 (slate-blue muted) — distinct from accentBlue (saturated
  // blue used for trending). Quiet maps to ink80 rather than textMuted
  // so the regime swatches stay visually separable.
  quiet: colors.ink80,
};
